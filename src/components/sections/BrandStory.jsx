...
//               <img
//                 src="/pothe-pwa/images/brand/semblanza.jpg"
...
const BrandStory = () => {
  ...
  const handleVerConocenos = () => {
    navigate('/conocenos');
  };

  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          
          {/* Contenido de texto - Primero en móvil */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
          ...
          >
            ...
            {/* Título principal */}
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
              Helados que cuentan
              <span className="text-morado-500 block">
                una historia
              </span>
            ...
            <div className="grid grid-cols-3 gap-4 py-6">
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-morado-600 dark:text-morado-400">
                  80+
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Sabores únicos
              ...
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-orange-500 dark:text-orange-400">
                  5
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Años de experiencia
          ...
          {/* Imagen del local o fundadores - Segundo en móvil */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
